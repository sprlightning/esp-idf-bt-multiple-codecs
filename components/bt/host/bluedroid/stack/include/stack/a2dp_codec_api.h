...
/* This interface uses the A2DP-only types (tA2D_STATUS, tA2D_CODEC_TYPE, ...)
 * which are themselves guarded by A2D_INCLUDED in a2d_api.h. Guard the whole
 * body so a BLE-only build (Classic BT / A2DP disabled) that still parses this
 * header via esp_a2dp_api.c does not reference undefined types. */
...
typedef struct {
  ...
  ssize_t (*decode_packet_header)(BT_HDR* p_buf);
